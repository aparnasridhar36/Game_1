...
class StartTile(MapTile):
	description = """You find yourself in a maze with musty gray walls.
		You can make out four paths, each equally as dark and foreboding.
		"""


class BoringTile(MapTile):
	description = """This is a very boring part of the maze."""

		
		
class FireElementTile(MapTile):
	description = """You've entered the fire element! Don't get burnt!"""
		
		
class WaterElementTile(MapTile):
	description = """You've entered the water element! Don't get soaked!"""
		

class AirElementTile(MapTile):
	description = """You've entered the air element! Don't get blown away!"""
		
		
class EarthElementTile(MapTile):
	description = """You've entered the earth element! Watch for dirt!"""
		

class SecretTile(MapTile):
	description = """You've entered a secret dead end."""
